...
const PreviewPemilikDo = ({route, navigation}) => {
    ...
    return(
        <View style={{flex:1}}>
            ...
            <DetailPemilikDo username={username} id_ppks={id_ppks} nama_do={nama_do} tanggal_perubahan_harga={tanggal_perubahan_harga} hargaDoPPKS={hargaDoPPKS} keterangan_biaya_bongkar={keterangan_biaya_bongkar} keterangan_harga={keterangan_harga} navigation={navigation} setModalVisible={setModalVisible} />
        </View>
    )
}
