...
import * as RootNavigation from './src/pages/BottomNavStackNavigatorPages/HomeStackNavigator/RootNavigation';
...
export default class NotifService {
  ...
  localNotif(soundName, notif) {
    ...
    PushNotification.localNotification({
      ...
      subtitle: "Local notification", // (optional) smaller title below notification title
      foreground: false,
